...
![Placeholder image](/bios_logo.webp "UEFITool bios logo section") ![Placeholder image](/hp_bios_logo.webp "HP BIOS logo")
<br>
...
![Placeholder image](/uefi_biosdiags_efi.webp "UEFITool BiosDiags.efi")
<br>
...
![Placeholder image](/embedded_pe_header.webp "embedded PE header")
...
An easy way to run EFI programs is launch QEMU with a UEFI BIOS, get a UEFI shell and invoke the program from there. Download a UEFI shell (or use [this one](/Shell.efi)) and build an EFI-bootable FAT32 disk.
...
![qemubiosdiags](/qemu_biosdiags_efi.webp "running BiosDiags.efi in QEMU")
...
![xpbackdoor](/backdoor_running.webp "backdoor running")
...
![wpbtlayout](/wpbt_layout.webp "wpbt layout")

It appears as if this is exactly what is going on here. Let's have a look.

![acpitable](/acpi_table_manipulation.webp "acpi table manipulation")
<br>
...
![installwpbt](/install_wpbt.webp "wpbt install")
...
![computrace](/computrace.webp "computrace")
...
#### HP BIOS & EFI Modules
[`BiosDiags.efi`](/BiosDiags.efi):`71b01f0ad7c1d990771aa675bc814d5f9b50a7958c005173cda0165139235666`
[`J61_0396.bin`](/J61_0396.bin):`05e89382e73afb280f637acbfa1029e9107dd30c78df37b6a00f184657f5f2c3`

#### UEFI BIOS for QEMU
[`OVMF.fd`](/OVMF.fd):`96a9aad279ac9fdb7d452b70cee71587a917aaa428e4c40e9a9cb35f5d718259`
[`Shell.efi`](/Shell.efi):`04c89f19efee2a22660fd4650ff9add88e962d102b1b713e535f4e32a07c5185`

#### Computrace 
[`rpcnetp.dll`](/rpcnetp.dll):`56c9ab9a663af6af931b3c76f32ed0f7402d6ed39f3538f72cb2757886ef7c40`
[`rpcnetp.exe`](/rpcnetp.exe):`1c6a20980a186225979f5e91bc48eaf77c67f50eea85eba9db4c3ec55c61d55f`