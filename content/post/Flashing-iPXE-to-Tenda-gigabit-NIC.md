...
![TPM PCR registers](/tenda_nic_chips_closeup.webp)
...
![EEPROM Fields](/eeprom-datasheet-realtek.webp)
...
![Clip on flash chip](/clip-on-flash-chip-tenda.webp)
...
![PCB](/pcb_examination.webp)

![flash chip pinout](/tenda_flash_chip_pinout.webp)
...
![pci registers bootrom](/pci-registers-bootrom.webp)

![pci romsize register](/romsize_register.webp)
...
![eeprom registers](/eeprom-config-registers.webp)

![config0](/config0-eeprom-register.webp)
